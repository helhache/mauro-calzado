            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="infantiles.php" class="text-white text-decoration-none">
                                <i class="bi bi-chevron-right text-danger"></i> Calzado Infantil
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="mujer.php" class="text-white text-decoration-none">
                                <i class="bi bi-chevron-right text-danger"></i> Calzado Mujer
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="hombre.php" class="text-white text-decoration-none">
                                <i class="bi bi-chevron-right text-danger"></i> Calzado Hombre
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="ofertas.php" class="text-white text-decoration-none">
                                <i class="bi bi-chevron-right text-danger"></i> Ofertas
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="nosotros.php" class="text-white text-decoration-none">
                                <i class="bi bi-chevron-right text-danger"></i> Sobre Nosotros
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="contactanos.php" class="text-white text-decoration-none">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="nosotros.php#envios" class="text-white text-decoration-none">
                                <i class="bi bi-chevron-right text-danger"></i> Envíos y Entregas
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="nosotros.php#pagos" class="text-white text-decoration-none">
                                <i class="bi bi-chevron-right text-danger"></i> Métodos de Pago
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="nosotros.php#cambios" class="text-white text-decoration-none">
                                <i class="bi bi-chevron-right text-danger"></i> Cambios y Devoluciones
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="nosotros.php#faq" class="text-white text-decoration-none">
                                <i class="bi bi-chevron-right text-danger"></i> Preguntas Frecuentes
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="terminos.php" class="text-white text-decoration-none">
