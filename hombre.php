...
// CONSTRUIR QUERY
$where = ["p.activo = 1", "c.slug = 'hombre'", "p.stock > 0"]; // FILTRO: Solo productos con stock
$params = [];
$types = "";
                ...
                <div class="card border-0 shadow-sm sticky-top" style="top: 80px; z-index: 100;">
                    <div class="card-body">
                        ...
                        <form method="GET" action="" id="form-filtros">
                            ...
                            <a href="hombre.php" class="btn btn-outline-secondary w-100">
                ...
                <div class="row">
                    ...
                    if (mysqli_num_rows($result_productos) > 0) {
                        ...
                        <div class="col-12 text-center py-5">
                            ...
                            <a href="hombre.php" class="btn btn-primary">Ver todos los productos</a>
                        </div>
                        <?php
                    }
                    ?>
